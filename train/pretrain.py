...
if __name__ == '__main__':
    ...
    parser.add_argument("--ds_limit", type=int, default=250000)
    ...
    parser.add_argument("--train_col_dec", type=int, default=1)
    parser.add_argument("--train_pln_dec", type=int, default=1)
    parser.add_argument("--train_ray_dec", type=int, default=1)
    ...
    for itr in range(10000):
        ...
        if best_occ_acc < cur_occ_acc:
            ...
            if not vessl_on:
                ...
                mesh_path = os.path.join(BASEDIR, 'data/NOCS/32_64_1_v4/bottle-1ef68777bfdb7d6ba7a07ee616e34cd7.obj')
        ...
        if not args.train_col_dec:
            cur_col_acc = 0
            best_col_acc = 0
        if not args.train_pln_dec:
            cur_pln_acc = 0
        if not args.train_ray_dec:
            cur_seg_acc = 0
